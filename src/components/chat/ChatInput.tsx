...
interface ChatInputProps {
  ...
  onCancelReply: () => void;
  animatedReplyPanelHeightStyle: any; // Height style from useAnimatedStyle
  animatedReplyPanelOpacityStyle: any; // Opacity style from useAnimatedStyle
...
const ChatInput: React.FC<ChatInputProps> = ({
  ...
  replyToMessage,
  onCancelReply,
  animatedReplyPanelHeightStyle,
  animatedReplyPanelOpacityStyle,
  ...
  return (
    <InputOuterContainer>
      <Animated.View style={animatedReplyPanelHeightStyle}>
        <Animated.View style={animatedReplyPanelOpacityStyle}>
          {replyToMessage && (
            <View style={{
              padding: 8,
